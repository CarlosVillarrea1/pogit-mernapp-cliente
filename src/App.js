...
const addFriend = () => {
  Axios.post("https://crud-mern-cavl.herokuapp.com/addFriend", {
    name : name,
    age : age,
...
const updateFriend = (id) => {
  ...
  Axios.put("https://crud-mern-cavl.herokuapp.com/update", { newAge: newAge, newDescription : newDescription, id : id}).then(() => {
...
const deleteFriend = (id) =>{
  Axios.delete(`https://crud-mern-cavl.herokuapp.com/delete/${id}`).then(()=>{
  ...
  useEffect(() => {
    Axios.get("https://crud-mern-cavl.herokuapp.com/read")
    .then((response) => {
